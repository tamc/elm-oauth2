...
{
	if (region.V.A === region.ae.A)
	{
		return 'on line ' + region.V.A;
	}
	return 'on lines ' + region.V.A + ' through ' + region.ae.A;
}
...
var _Http_toTask = F2(function(request, maybeProgress)
{
	return _Scheduler_binding(function(callback)
	{
		...
		xhr.addEventListener('load', function() {
			callback(_Http_handleResponse(xhr, request.aj.a));
		});

		try
		{
			xhr.open(request.am, request.J, true);
		}
		catch (e)
		{
			return callback(_Scheduler_fail(elm$http$Http$BadUrl(request.J)));
		}
...
function _Http_toResponse(xhr)
{
	return {
		J: xhr.responseURL,
		bb: { ac: xhr.status, j: xhr.statusText },
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aR: 'hidden', y: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aR: 'mozHidden', y: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aR: 'msHidden', y: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aR: 'webkitHidden', y: 'webkitvisibilitychange' }
		: { aR: 'hidden', y: 'visibilitychange' };
}
...
var author$project$Main$SignInRequested = function (a) {
	return {$: 1, a: a};
};
var author$project$Main$SignOutRequested = {$: 2};
...
var author$project$Internal$makeHeaders = function (credentials) {
	return A2(
...
var author$project$Internal$protocolToString = function (protocol) {
	if (!protocol) {
		return 'http';
	} else {
		return 'https';
...
var author$project$Internal$makeRedirectUri = function (url) {
	return elm$core$String$concat(
		_List_fromArray(
			[
				author$project$Internal$protocolToString(url.a5),
				'://',
				url.aS,
				A2(
				elm$core$Maybe$withDefault,
...
var author$project$Internal$AuthenticationSuccess = F4(
	function (token, refreshToken, expiresIn, scope) {
		return {aO: expiresIn, a7: refreshToken, U: scope, bf: token};
	});
...
var author$project$Internal$expiresInDecoder = elm$json$Json$Decode$maybe(
...
var author$project$Internal$decoderFromJust = function (msg) {
	return A2(
...
var author$project$OAuth$maybeAndThen2 = F3(
	function (fn, ma, mb) {
		return A2(
...
var author$project$OAuth$Bearer = elm$core$Basics$identity;
...
var author$project$OAuth$tokenFromString = function (str) {
...
var author$project$OAuth$makeRefreshToken = F2(
	function (tokenType, mToken) {
		var construct = F2(
			function (a, b) {
				return author$project$OAuth$tokenFromString(a + (' ' + b));
			});
		var _n0 = _Utils_Tuple2(
			mToken,
			A3(
				author$project$OAuth$maybeAndThen2,
				construct,
...
var author$project$Internal$refreshTokenDecoder = A2(
	elm$json$Json$Decode$andThen,
	author$project$Internal$decoderFromJust('missing or invalid \'refresh_token\' / \'token_type\''),
	A3(
...
var author$project$Internal$scopeDecoder = A2(
...
var author$project$OAuth$makeToken = F2(
	function (mTokenType, mToken) {
		var construct = F2(
			function (a, b) {
				return author$project$OAuth$tokenFromString(a + (' ' + b));
			});
		return A3(author$project$OAuth$maybeAndThen2, construct, mTokenType, mToken);
	});
var author$project$Internal$tokenDecoder = A2(
	elm$json$Json$Decode$andThen,
	author$project$Internal$decoderFromJust('missing or invalid \'access_token\' / \'token_type\''),
	A3(
		elm$json$Json$Decode$map2,
...
var author$project$Internal$authenticationSuccessDecoder = A5(elm$json$Json$Decode$map4, author$project$Internal$AuthenticationSuccess, author$project$Internal$tokenDecoder, author$project$Internal$refreshTokenDecoder, author$project$Internal$expiresInDecoder, author$project$Internal$scopeDecoder);
...
var elm$http$Http$expectJson = function (decoder) {
	return elm$http$Http$expectStringResponse(
		function (response) {
			var _n0 = A2(elm$json$Json$Decode$decodeString, decoder, response._);
			if (_n0.$ === 1) {
...
var author$project$Internal$makeRequest = F3(
	function (url, headers, body) {
		return {
			_: A2(elm$http$Http$stringBody, 'application/x-www-form-urlencoded', body),
			aj: elm$http$Http$expectJson(author$project$Internal$authenticationSuccessDecoder),
			ak: headers,
			am: 'POST',
			aC: elm$core$Maybe$Nothing,
			J: elm$url$Url$toString(url),
			aE: false
		};
	});
...
var author$project$OAuth$AuthorizationCode$makeTokenRequest = function (_n0) {
	var credentials = _n0.aM;
	var code = _n0.ac;
	var url = _n0.J;
	var redirectUri = _n0.aw;
	var headers = author$project$Internal$makeHeaders(
		function () {
			var _n1 = credentials.a9;
			if (_n1.$ === 1) {
				return elm$core$Maybe$Nothing;
			} else {
				var secret = _n1.a;
				return elm$core$Maybe$Just(
					{O: credentials.O, a9: secret});
			}
		}());
	var body = A2(
		...
		elm$url$Url$Builder$toQuery(
			_List_fromArray(
				[
					...
					A2(elm$url$Url$Builder$string, 'client_id', credentials.O),
					A2(
					elm$url$Url$Builder$string,
					'redirect_uri',
					author$project$Internal$makeRedirectUri(redirectUri)),
					A2(elm$url$Url$Builder$string, 'code', code)
				])));
	return A3(author$project$Internal$makeRequest, url, headers, body);
};
...
var author$project$Main$getAccessToken = F3(
	function (config, redirectUri, code) {
		var clientId = config.O;
		var secret = config.a9;
		var tokenEndpoint = config.bg;
		return A2(
			elm$http$Http$send,
			author$project$Main$GotAccessToken(config),
				...
				author$project$OAuth$AuthorizationCode$makeTokenRequest(
					{
						...
						aM: {
							O: clientId,
							a9: elm$core$Maybe$Just(secret)
						},
						aw: redirectUri,
						J: tokenEndpoint
					})));
	});
var author$project$OAuth$errorCodeToString = function (err) {
	switch (err.$) {
		case 0:
...
var author$project$Internal$AuthorizationError = F4(
	function (error, errorDescription, errorUri, state) {
		return {af: error, ag: errorDescription, ah: errorUri, W: state};
	});
...
var author$project$Internal$errorDescriptionParser = elm$url$Url$Parser$Query$string('error_description');
var author$project$Internal$errorUriParser = elm$url$Url$Parser$Query$string('error_uri');
var author$project$Internal$stateParser = elm$url$Url$Parser$Query$string('state');
...
var author$project$Internal$authorizationErrorParser = function (errorCode) {
	return A4(
		elm$url$Url$Parser$Query$map3,
		author$project$Internal$AuthorizationError(errorCode),
		author$project$Internal$errorDescriptionParser,
		author$project$Internal$errorUriParser,
		author$project$Internal$stateParser);
};
var author$project$OAuth$AuthorizationCode$defaultAuthorizationErrorParser = author$project$Internal$authorizationErrorParser;
var author$project$OAuth$AuthorizationCode$AuthorizationSuccess = F2(
	function (code, state) {
		return {ac: code, W: state};
	});
...
var author$project$Internal$errorParser = function (errorCodeFromString) {
	return A2(
		elm$url$Url$Parser$Query$map,
		elm$core$Maybe$map(errorCodeFromString),
		elm$url$Url$Parser$Query$string('error'));
};
var author$project$OAuth$AccessDenied = {$: 2};
var author$project$OAuth$Custom = function (a) {
	return {$: 7, a: a};
};
var author$project$OAuth$InvalidRequest = {$: 0};
var author$project$OAuth$InvalidScope = {$: 4};
var author$project$OAuth$ServerError = {$: 5};
var author$project$OAuth$TemporarilyUnavailable = {$: 6};
var author$project$OAuth$UnauthorizedClient = {$: 1};
var author$project$OAuth$UnsupportedResponseType = {$: 3};
...
var author$project$OAuth$AuthorizationCode$defaultErrorParser = author$project$Internal$errorParser(author$project$OAuth$errorCodeFromString);
var author$project$OAuth$AuthorizationCode$defaultParsers = {M: author$project$OAuth$AuthorizationCode$defaultAuthorizationErrorParser, N: author$project$OAuth$AuthorizationCode$defaultAuthorizationSuccessParser, P: author$project$OAuth$AuthorizationCode$defaultCodeParser, Q: author$project$OAuth$AuthorizationCode$defaultErrorParser};
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {m: frag, o: params, l: unvisited, h: value, p: visited};
	});
...
var author$project$Internal$parseUrlQuery = F3(
...
var author$project$OAuth$AuthorizationCode$Empty = {$: 0};
...
var author$project$OAuth$AuthorizationCode$parseCodeWith = F2(
	function (_n0, url_) {
		var codeParser = _n0.P;
		var errorParser = _n0.Q;
		var authorizationSuccessParser = _n0.N;
		var authorizationErrorParser = _n0.M;
		...
		while (true) {
			if (!_n1.$) {
				if (!_n1.a.a.$) {
					...
					var code = _n2.a.a;
					return A3(
						author$project$Internal$parseUrlQuery,
						url,
...
var author$project$OAuth$Examples$Common$Google = 0;
var author$project$OAuth$Examples$Common$LinkedIn = 2;
var author$project$OAuth$Examples$Common$Profile = F2(
	function (name, picture) {
		return {ap: name, ar: picture};
	});
var author$project$OAuth$Examples$Common$Spotify = 1;
var elm$json$Json$Decode$index = _Json_decodeIndex;
var elm$url$Url$Https = 1;
var author$project$OAuth$Examples$Common$configurationFor = function (provider) {
	var defaultHttpsUrl = {z: elm$core$Maybe$Nothing, aS: '', a0: '', a1: elm$core$Maybe$Nothing, a5: 1, I: elm$core$Maybe$Nothing};
	switch (provider) {
		case 0:
			return {
				aH: _Utils_update(
					defaultHttpsUrl,
					{aS: 'accounts.google.com', a0: '/o/oauth2/v2/auth'}),
				O: '909608474358-fkok86ks7e83c47aq01aiit47vsoh4s0.apps.googleusercontent.com',
				a3: A3(
					elm$json$Json$Decode$map2,
					author$project$OAuth$Examples$Common$Profile,
					A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
					A2(elm$json$Json$Decode$field, 'picture', elm$json$Json$Decode$string)),
				a4: _Utils_update(
					defaultHttpsUrl,
					{aS: 'www.googleapis.com', a0: '/oauth2/v1/userinfo'}),
				a6: 0,
				U: _List_fromArray(
					['profile']),
				a9: '<secret>',
				bg: _Utils_update(
					defaultHttpsUrl,
					{aS: 'www.googleapis.com', a0: '/oauth2/v4/token'})
			};
		case 1:
			return {
				aH: _Utils_update(
					defaultHttpsUrl,
					{aS: 'accounts.spotify.com', a0: '/authorize'}),
				O: '391d08ef3d7a46558493cb822a991dbb',
				a3: A3(
					elm$json$Json$Decode$map2,
					author$project$OAuth$Examples$Common$Profile,
				...
				a4: _Utils_update(
					defaultHttpsUrl,
					{aS: 'api.spotify.com', a0: '/v1/me'}),
				a6: 1,
				U: _List_Nil,
				a9: '<secret>',
				bg: _Utils_update(
					defaultHttpsUrl,
					{aS: 'accounts.spotify.com', a0: '/api/token'})
			};
		default:
			return {
				aH: _Utils_update(
					defaultHttpsUrl,
					{aS: 'www.linkedin.com', a0: '/oauth/v2/authorization'}),
				O: '778vrrt6dbp865',
				a3: A3(
					elm$json$Json$Decode$map2,
					author$project$OAuth$Examples$Common$Profile,
				...
				bg: _Utils_update(
					defaultHttpsUrl,
					{aS: 'www.linkedin.com', a0: '/oauth/v2/accessToken'})
			};
	}
};
var author$project$OAuth$Examples$Common$makeInitModel = F2(
	function (bytes, origin) {
		return {
			af: elm$core$Maybe$Nothing,
			a2: elm$core$Maybe$Nothing,
			aw: _Utils_update(
				origin,
				{z: elm$core$Maybe$Nothing, I: elm$core$Maybe$Nothing}),
			W: bytes,
			bf: elm$core$Maybe$Nothing
		};
	});
var author$project$OAuth$Examples$Common$oauthProviderFromString = function (str) {
	switch (str) {
		case 'google':
...
var author$project$OAuth$Examples$Common$stringLeftUntil = F2(
	function (predicate, str) {
		...
		var h = _n0.a;
		var q = _n0.b;
		return ((h === '') || predicate(h)) ? '' : _Utils_ap(
			h,
			A2(author$project$OAuth$Examples$Common$stringLeftUntil, predicate, q));
	});
var author$project$OAuth$Examples$Common$oauthProviderFromState = function (str) {
	return author$project$OAuth$Examples$Common$oauthProviderFromString(
		A2(
			author$project$OAuth$Examples$Common$stringLeftUntil,
			function (c) {
				return c === '.';
			},
			str));
};
var author$project$OAuth$Examples$Common$stringDropLeftUntil = F2(
	function (predicate, str) {
		stringDropLeftUntil:
		while (true) {
			var _n0 = _Utils_Tuple2(
			...
			if ((q === '') || predicate(h)) {
				...
				str = $temp$str;
				continue stringDropLeftUntil;
			}
		}
	});
var author$project$OAuth$Examples$Common$randomBytesFromState = function (str) {
	return A2(
		author$project$OAuth$Examples$Common$stringDropLeftUntil,
		function (c) {
			return c === '.';
		},
		str);
...
var author$project$Main$init = F3(
	function (_n0, origin, _n1) {
		var randomBytes = _n0.av;
		var model = A2(author$project$OAuth$Examples$Common$makeInitModel, randomBytes, origin);
		var _n2 = author$project$OAuth$AuthorizationCode$parseCode(origin);
		switch (_n2.$) {
			case 2:
				var code = _n2.a.ac;
				var state = _n2.a.W;
				if (!_Utils_eq(
					A2(elm$core$Maybe$map, author$project$OAuth$Examples$Common$randomBytesFromState, state),
					elm$core$Maybe$Just(model.W))) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								af: elm$core$Maybe$Just('\'state\' doesn\'t match, the request has likely been forged by an adversary!')
							}),
					...
					var _n3 = A2(
						...
						A2(
							elm$core$Basics$composeL,
							elm$core$Maybe$map(author$project$OAuth$Examples$Common$configurationFor),
							author$project$OAuth$Examples$Common$oauthProviderFromState),
						state);
					if (_n3.$ === 1) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									af: elm$core$Maybe$Just('Couldn\'t recover OAuthProvider from state')
								}),
							elm$core$Platform$Cmd$none);
					} else {
						var config = _n3.a;
						return _Utils_Tuple2(
							model,
							A3(author$project$Main$getAccessToken, config, model.aw, code));
					}
				}
			case 0:
					...
					_Utils_update(
						model,
						{
							af: elm$core$Maybe$Just(
								author$project$OAuth$errorCodeToString(err.af))
						}),
					elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$sideNote = _List_fromArray(
	[
		...
		_List_fromArray(
			[
				elm$html$Html$text('Authorization Code')
			])),
		A2(
		elm$html$Html$p,
		_List_Nil,
		...
		_List_fromArray(
			[
				elm$html$Html$text('A few interesting notes about this demo:'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('This demo application requires basic scopes from the authorization servers in order to display your name and profile picture, illustrating the demo.')
							])),
						A2(
						elm$html$Html$li,
						_List_fromArray(
						...
						_List_fromArray(
							[
								elm$html$Html$text('You can observe the URL in the browser navigation bar and requests made against the authorization servers!')
							])),
						A2(
						elm$html$Html$li,
						_List_fromArray(
						...
						_List_fromArray(
							[
								elm$html$Html$text('None of the \'authentication\' steps in this demo will work for it uses dummy secrets. Yet, it is still possible to do the \'authorization\' step to retrieve an authorization code. You may try to submit this code via cURL to obtain an access token.')
							]))
					]))
			]))
	]);
...
var author$project$OAuth$tokenToString = function (_n0) {
	var t = _n0;
	return 'Bearer ' + t;
};
...
var author$project$Main$getUserInfo = F2(
	function (_n0, token) {
		var profileEndpoint = _n0.a4;
		var profileDecoder = _n0.a3;
		return A2(
			elm$http$Http$send,
			author$project$Main$GotUserInfo,
			elm$http$Http$request(
				{
					_: elm$http$Http$emptyBody,
					aj: elm$http$Http$expectJson(profileDecoder),
					ak: A2(author$project$OAuth$useToken, token, _List_Nil),
					am: 'GET',
					aC: elm$core$Maybe$Nothing,
					J: elm$url$Url$toString(profileEndpoint),
					aE: false
				}));
	});
var author$project$Internal$AuthenticationError = F3(
	function (error, errorDescription, errorUri) {
		return {af: error, ag: errorDescription, ah: errorUri};
	});
var author$project$Internal$errorDescriptionDecoder = elm$json$Json$Decode$maybe(
	A2(elm$json$Json$Decode$field, 'error_description', elm$json$Json$Decode$string));
var author$project$Internal$errorUriDecoder = elm$json$Json$Decode$maybe(
	A2(elm$json$Json$Decode$field, 'error_uri', elm$json$Json$Decode$string));
var elm$json$Json$Decode$map3 = _Json_map3;
var author$project$Internal$authenticationErrorDecoder = function (errorCodeDecoder) {
	return A4(elm$json$Json$Decode$map3, author$project$Internal$AuthenticationError, errorCodeDecoder, author$project$Internal$errorDescriptionDecoder, author$project$Internal$errorUriDecoder);
};
var author$project$Internal$errorDecoder = function (errorCodeFromString) {
	return A2(
		elm$json$Json$Decode$map,
		errorCodeFromString,
		A2(elm$json$Json$Decode$field, 'error', elm$json$Json$Decode$string));
};
var author$project$OAuth$AuthorizationCode$defaultErrorDecoder = author$project$Internal$errorDecoder(author$project$OAuth$errorCodeFromString);
var author$project$OAuth$AuthorizationCode$defaultAuthenticationErrorDecoder = author$project$Internal$authenticationErrorDecoder(author$project$OAuth$AuthorizationCode$defaultErrorDecoder);
var author$project$Internal$Code = 0;
var author$project$Internal$responseTypeToString = function (r) {
	if (!r) {
		return 'code';
	} else {
		return 'token';
...
var author$project$Internal$urlAddList = F3(
...
var author$project$Internal$urlAddMaybe = F3(
...
var author$project$Internal$makeAuthUrl = F2(
	function (responseType, _n0) {
		var clientId = _n0.O;
		var url = _n0.J;
		var redirectUri = _n0.aw;
		var scope = _n0.U;
		...
		var query = A2(
			...
			elm$url$Url$Builder$toQuery(
				A3(
					author$project$Internal$urlAddMaybe,
					'state',
					state,
					A3(
						author$project$Internal$urlAddList,
						'scope',
						scope,
						_List_fromArray(
							[
								...
								elm$url$Url$Builder$string,
								'response_type',
								author$project$Internal$responseTypeToString(responseType))
							])))));
		var _n1 = url.I;
		if (_n1.$ === 1) {
			...
			return _Utils_update(
				url,
				{
					I: elm$core$Maybe$Just(baseQuery + ('&' + query))
				});
		}
	});
var author$project$OAuth$AuthorizationCode$makeAuthUrl = author$project$Internal$makeAuthUrl(0);
...
var author$project$OAuth$Examples$Common$errorResponseToString = function (_n0) {
	var error = _n0.af;
	var errorDescription = _n0.ag;
	var desc = A3(
		elm$core$String$replace,
		'+',
		' ',
		A2(elm$core$Maybe$withDefault, '', errorDescription));
	var code = author$project$OAuth$errorCodeToString(error);
	return code + (': ' + desc);
};
var author$project$OAuth$Examples$Common$oauthProviderToString = function (provider) {
	switch (provider) {
		case 0:
			return 'google';
		case 1:
...
var author$project$OAuth$Examples$Common$makeState = F2(
	function (suffix, provider) {
		return author$project$OAuth$Examples$Common$oauthProviderToString(provider) + ('.' + suffix);
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {z: fragment, aS: host, a0: path, a1: port_, a5: protocol, I: query};
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				var scope = msg.a.U;
				var provider = msg.a.a6;
				var clientId = msg.a.O;
				var authorizationEndpoint = msg.a.aH;
				var auth = {
					O: clientId,
					aw: model.aw,
					U: scope,
					W: elm$core$Maybe$Just(
						A2(author$project$OAuth$Examples$Common$makeState, model.W, provider)),
					J: authorizationEndpoint
				};
				return _Utils_Tuple2(
					model,
					elm$browser$Browser$Navigation$load(
						elm$url$Url$toString(
							author$project$OAuth$AuthorizationCode$makeAuthUrl(auth))));
			case 2:
				return _Utils_Tuple2(
					model,
					elm$browser$Browser$Navigation$load(
						elm$url$Url$toString(model.aw)));
			case 3:
				var config = msg.a;
				var res = msg.b;
				if (res.$ === 1) {
					if (res.a.$ === 3) {
						var body = res.a.a._;
						var _n2 = A2(elm$json$Json$Decode$decodeString, author$project$OAuth$AuthorizationCode$defaultAuthenticationErrorDecoder, body);
						if (!_n2.$) {
							var error = _n2.a.af;
							var errorDescription = _n2.a.ag;
							var errMsg = 'Unable to retrieve token: ' + author$project$OAuth$Examples$Common$errorResponseToString(
								{af: error, ag: errorDescription});
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										af: elm$core$Maybe$Just(errMsg)
									}),
								elm$core$Platform$Cmd$none);
						} else {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										af: elm$core$Maybe$Just('Unable to retrieve token: ' + body)
									}),
								elm$core$Platform$Cmd$none);
						}
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									af: elm$core$Maybe$Just('Unable to retrieve token: HTTP request failed. CORS is likely disabled on the authorization server.')
								}),
							elm$core$Platform$Cmd$none);
					}
				} else {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								bf: elm$core$Maybe$Just(token)
							}),
						A2(author$project$Main$getUserInfo, config, token));
				}
			default:
				var res = msg.a;
				if (res.$ === 1) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								af: elm$core$Maybe$Just('Unable to retrieve user profile: HTTP request failed.')
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var profile = res.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								a2: elm$core$Maybe$Just(profile)
							}),
						elm$core$Platform$Cmd$none);
				}
		}
...
var author$project$OAuth$Examples$Common$viewError = function (error) {
	if (error.$ === 1) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
...
var author$project$OAuth$Examples$Common$viewBody = F2(
	function (model, content) {
		return A2(
			...
			A2(
				elm$core$List$cons,
				author$project$OAuth$Examples$Common$viewError(model.af),
				content));
	});
var author$project$OAuth$Examples$Common$viewFetching = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			A2(elm$html$Html$Attributes$style, 'color', '#757575'),
			A2(elm$html$Html$Attributes$style, 'font', 'Roboto Arial'),
			A2(elm$html$Html$Attributes$style, 'text-align', 'center'),
			A2(elm$html$Html$Attributes$style, 'display', 'flex'),
			A2(elm$html$Html$Attributes$style, 'align-items', 'center'),
			A2(elm$html$Html$Attributes$style, 'justify-content', 'center')
	...
	_List_fromArray(
		[
			elm$html$Html$text('fetching profile...')
		]));
var author$project$OAuth$Examples$Common$viewLogin = function (_n0) {
	var buttons = _n0.aI;
	var sideNote = _n0.ba;
	return _List_fromArray(
		[
...
var author$project$OAuth$Examples$Common$viewProfile = F2(
	function (onSignOut, profile) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$src(profile.ar),
							A2(elm$html$Html$Attributes$style, 'height', '15em'),
							A2(elm$html$Html$Attributes$style, 'width', '15em'),
							A2(elm$html$Html$Attributes$style, 'border-radius', '50%'),
							A2(elm$html$Html$Attributes$style, 'box-shadow', 'rgba(0,0,0,0.25) 0 0 4px 2px')
						]),
					_List_Nil),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
							...
							A2(elm$html$Html$Attributes$style, 'font', '24px Roboto, Arial'),
							A2(elm$html$Html$Attributes$style, 'color', '#757575')
						]),
					_List_fromArray(
						[
							elm$html$Html$text(profile.ap)
						])),
					A2(
					elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Events$onClick(onSignOut),
...
var author$project$OAuth$Examples$Common$view = F3(
	function (title, _n0, model) {
		var onSignOut = _n0.aY;
		var buttons = _n0.aI;
		var sideNote = _n0.ba;
		var content = function () {
			var _n1 = _Utils_Tuple2(model.bf, model.a2);
			if (_n1.b.$ === 1) {
				if (_n1.a.$ === 1) {
					var _n2 = _n1.a;
					var _n3 = _n1.b;
					return author$project$OAuth$Examples$Common$viewLogin(
						{aI: buttons, ba: sideNote});
				} else {
					var token = _n1.a.a;
					var _n4 = _n1.b;
					return _List_fromArray(
						[author$project$OAuth$Examples$Common$viewFetching]);
				}
			} else {
				var profile = _n1.b.a;
				return _List_fromArray(
					[
						A2(author$project$OAuth$Examples$Common$viewProfile, onSignOut, profile)
					]);
			}
		}();
		return {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					onSignIn(
						author$project$OAuth$Examples$Common$configurationFor(provider)))
				]),
			_List_fromArray(
				[
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		aZ: elm$core$Basics$always(author$project$Main$NoOp),
		a_: elm$core$Basics$always(author$project$Main$NoOp),
		bd: elm$core$Basics$always(elm$core$Platform$Sub$none),
		bh: author$project$Main$update,
		bi: A2(
			author$project$OAuth$Examples$Common$view,
			'Elm OAuth2 Example - AuthorizationCode Flow',
			{
				aI: _List_fromArray(
					[
						A2(author$project$OAuth$Examples$Common$viewSignInButton, 0, author$project$Main$SignInRequested),
						A2(author$project$OAuth$Examples$Common$viewSignInButton, 1, author$project$Main$SignInRequested),
						A2(author$project$OAuth$Examples$Common$viewSignInButton, 2, author$project$Main$SignInRequested)
					]),
				aY: author$project$Main$SignOutRequested,
				ba: author$project$Main$sideNote
			})
	});
