...
{
	if (region.U.A === region.ad.A)
	{
		return 'on line ' + region.U.A;
	}
	return 'on lines ' + region.U.A + ' through ' + region.ad.A;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.al, request.H, true);
		} catch (e) {
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.timeout = request.aE.a || 0;
	xhr.responseType = request.ai.d;
	xhr.withCredentials = request.q;
}
...
var author$project$Internal$AuthenticationSuccess = F4(
	function (token, refreshToken, expiresIn, scope) {
		return {aO: expiresIn, a8: refreshToken, S: scope, bh: token};
	});
...
var author$project$Internal$makeRequest = F4(
	function (toMsg, url, headers, body) {
		return {
			Z: A2(elm$http$Http$stringBody, 'application/x-www-form-urlencoded', body),
			ai: A2(elm$http$Http$expectJson, toMsg, author$project$Internal$authenticationSuccessDecoder),
			aj: headers,
			al: 'POST',
			aE: elm$core$Maybe$Nothing,
			aF: elm$core$Maybe$Nothing,
			H: elm$url$Url$toString(url)
		};
	});
...
var author$project$OAuth$AuthorizationCode$makeTokenRequest = F2(
	function (toMsg, _n0) {
		...
		var code = _n0.ab;
		var url = _n0.H;
		var redirectUri = _n0.av;
		var headers = author$project$Internal$makeHeaders(
			function () {
				var _n1 = credentials.ba;
				if (_n1.$ === 1) {
					return elm$core$Maybe$Nothing;
				} else {
					var secret = _n1.a;
					return elm$core$Maybe$Just(
						{M: credentials.M, ba: secret});
				}
			}());
		var body = A2(
			...
			elm$url$Url$Builder$toQuery(
				_List_fromArray(
					[
						...
						A2(elm$url$Url$Builder$string, 'client_id', credentials.M),
						A2(
		...
		return A4(author$project$Internal$makeRequest, toMsg, url, headers, body);
	});
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{q: false, Z: r.Z, ai: r.ai, aj: r.aj, al: r.al, aE: r.aE, aF: r.aF, H: r.H}));
};
var author$project$Main$getAccessToken = F3(
	function (config, redirectUri, code) {
		var clientId = config.M;
		var secret = config.ba;
		var tokenEndpoint = config.bi;
		return elm$http$Http$request(
			A2(
...
var author$project$Internal$AuthorizationError = F4(
	function (error, errorDescription, errorUri, state) {
		return {ae: error, af: errorDescription, ag: errorUri, V: state};
	});
...
var author$project$OAuth$AuthorizationCode$defaultParsers = {K: author$project$OAuth$AuthorizationCode$defaultAuthorizationErrorParser, L: author$project$OAuth$AuthorizationCode$defaultAuthorizationSuccessParser, N: author$project$OAuth$AuthorizationCode$defaultCodeParser, O: author$project$OAuth$AuthorizationCode$defaultErrorParser};
...
var author$project$OAuth$AuthorizationCode$parseCodeWith = F2(
	function (_n0, url_) {
		var codeParser = _n0.N;
		var errorParser = _n0.O;
		var authorizationSuccessParser = _n0.L;
		var authorizationErrorParser = _n0.K;
...
var author$project$OAuth$Examples$Common$configurationFor = function (provider) {
	var defaultHttpsUrl = {z: elm$core$Maybe$Nothing, aS: '', a0: '', a1: elm$core$Maybe$Nothing, a5: 1, G: elm$core$Maybe$Nothing};
	switch (provider) {
		case 0:
			return {
				aJ: _Utils_update(
				...
				M: '909608474358-fkok86ks7e83c47aq01aiit47vsoh4s0.apps.googleusercontent.com',
				a3: A3(
					elm$json$Json$Decode$map2,
		...
		case 1:
			return {
				...
				M: '391d08ef3d7a46558493cb822a991dbb',
				a3: A3(
					elm$json$Json$Decode$map2,
					author$project$OAuth$Examples$Common$Profile,
...
var author$project$OAuth$Examples$Common$makeInitModel = F2(
	function (bytes, origin) {
		return {
			...
			av: _Utils_update(
				origin,
				{z: elm$core$Maybe$Nothing, G: elm$core$Maybe$Nothing}),
			V: bytes,
				...
				if (!_Utils_eq(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								ae: elm$core$Maybe$Just('\'state\' doesn\'t match, the request has likely been forged by an adversary!')
							}),
					...
					if (_n3.$ === 1) {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									ae: elm$core$Maybe$Just('Couldn\'t recover OAuthProvider from state')
								}),
							elm$core$Platform$Cmd$none);
					} else {
						var config = _n3.a;
						return _Utils_Tuple2(
							model,
							A3(author$project$Main$getAccessToken, config, model.av, code));
					}
				}
			case 0:
					...
					_Utils_update(
						model,
						{
							ae: elm$core$Maybe$Just(
								author$project$OAuth$errorCodeToString(err.ae))
						}),
					elm$core$Platform$Cmd$none);
		}
	});
		...
		return elm$http$Http$request(
			{
				...
				ai: A2(elm$http$Http$expectJson, author$project$Main$GotUserInfo, profileDecoder),
				aj: A2(author$project$OAuth$useToken, token, _List_Nil),
				al: 'GET',
				aE: elm$core$Maybe$Nothing,
				aF: elm$core$Maybe$Nothing,
				H: elm$url$Url$toString(profileEndpoint)
			});
	});
var author$project$Internal$AuthenticationError = F3(
	function (error, errorDescription, errorUri) {
		return {ae: error, af: errorDescription, ag: errorUri};
	});
	...
	function (responseType, _n0) {
		...
		if (_n1.$ === 1) {
			...
			return _Utils_update(
				url,
				{
					G: elm$core$Maybe$Just(baseQuery + ('&' + query))
				});
		}
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {z: fragment, aS: host, a0: path, a1: port_, a5: protocol, G: query};
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 1:
				...
				var clientId = msg.a.M;
				var authorizationEndpoint = msg.a.aJ;
				var auth = {
					M: clientId,
					av: model.av,
					S: scope,
					V: elm$core$Maybe$Just(
						A2(author$project$OAuth$Examples$Common$makeState, model.V, provider)),
					H: authorizationEndpoint
				};
				return _Utils_Tuple2(
					model,
					...
					if (res.a.$ === 4) {
						...
						if (!_n2.$) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										ae: elm$core$Maybe$Just('Unable to retrieve token: ' + body)
									}),
								elm$core$Platform$Cmd$none);
						}
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									ae: elm$core$Maybe$Just('Unable to retrieve token: HTTP request failed. CORS is likely disabled on the authorization server.')
								}),
							elm$core$Platform$Cmd$none);
					}
				} else {
				...
				if (res.$ === 1) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								ae: elm$core$Maybe$Just('Unable to retrieve user profile: HTTP request failed.')
							}),
						elm$core$Platform$Cmd$none);
				} else {
					var profile = res.a;
...
var author$project$OAuth$Examples$Common$viewBody = F2(
	function (model, content) {
		return A2(
			...
			A2(
				elm$core$List$cons,
				author$project$OAuth$Examples$Common$viewError(model.ae),
				content));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$src(profile.aq),
...
var author$project$OAuth$Examples$Common$view = F3(
	function (title, _n0, model) {
		...
		var content = function () {
			var _n1 = _Utils_Tuple2(model.bh, model.a2);
			if (_n1.b.$ === 1) {
				if (_n1.a.$ === 1) {
					var _n2 = _n1.a;
					var _n3 = _n1.b;
					return author$project$OAuth$Examples$Common$viewLogin(
						{aK: buttons, bc: sideNote});
				} else {
					var token = _n1.a.a;
					var _n4 = _n1.b;
					return _List_fromArray(
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		bk: A2(
			...
			'Elm OAuth2 Example - AuthorizationCode Flow',
			{
				...
				bc: author$project$Main$sideNote
			})
	});
